...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception{
        ...
        Player ederson = new Player("Ederson Moraes", Nationality.BRAZILIAN, Position.GOALKEEPER, 0, 0, 256, 2, 25, 2, manCity, "https://i2-prod.manchestereveningnews.co.uk/sport/football/football-news/article23323818.ece/ALTERNATES/s1200c/0_GettyImages-1238982945.jpg");
        ...
        Player nubel = new Player("Alexander Nubel", Nationality.GERMAN, Position.GOALKEEPER, 0, 0, 85, 0, 2 ,2, asMonaco,"https://pbs.twimg.com/media/FMxKqN7WUAU2kbT.jpg");
